...
bubble_images = [
    pygame.image.load(os.path.join(images_path, "red.png")).convert_alpha(),
    pygame.image.load(os.path.join(images_path, "yellow.png")).convert_alpha(),
    pygame.image.load(os.path.join(images_path, "blue.png")).convert_alpha(),
    pygame.image.load(os.path.join(images_path, "green.png")).convert_alpha(),
    pygame.image.load(os.path.join(images_path, "purple.png")).convert_alpha(),
    pygame.image.load(os.path.join(images_path, "black.png")).convert_alpha()
]
...
pointer_image = pygame.image.load(os.path.join(images_path, "pointer.png"))
...
wall = pygame.image.load(os.path.join(images_path, "wall.png"))
